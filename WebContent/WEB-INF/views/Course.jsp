...
<h1>UserItems</h1>
         ...
         <c:set var="currentCourses" value="${userCourseDto.courses}"/>
			<c:forEach var="row" items="${currentCourses}">
				<tr>
					...
					<td><a class="btn btn-outline-light" href="${pageContext.request.contextPath}/buy">Buy</a></td>
				</tr>
			</c:forEach>			
		</table>
		</div>
	...
	<c:set var="currentCourses" value="${userCourseDto.courses}"/>
		<c:if test="${countItems/visibleItems gt 1}">
			<br><br>
			<a href="${pageContext.request.contextPath}/usercourse?pageNumber=1">1</a>
			
			<a href="${pageContext.request.contextPath}/usercourse?pageNumber=1">4</a>
			
			<a href="${pageContext.request.contextPath}/usercourse?pageNumber=1">6</a>
			...
			<a href="${pageContext.request.contextPath}/usercourse?pageNumber=1">100</a>
		</c:if>
